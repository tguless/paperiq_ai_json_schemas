...
---
*Note: This is the cover page of the document, featuring a vertical orange bar on the left margin and the Nike logo in the top right corner.*
...
| **PART III** | **90** |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*(Except for the information set forth under “Information about our Executive Officers” in Item 1 above, Part III is incorporated by reference from the Proxy Statement for the NIKE, Inc. 2025 Annual Meeting of Shareholders.)* | |
...
graph TD
    ...
    AuditComm[Audit & Finance Committee]
    CTO[Chief Technology Officer]
    CIO[Chief Information Officer]
    VPCIS[VP, Corporate Information Security, Risk & Compliance]
    InternalAudit[Internal Audit]

    AuditComm -- Reports to --> Board
    CTO -- Reports to --> Board
    CIO -- Reports to --> CTO
    VPCIS -- Reports to --> CIO
    VPCIS -. Reviews with .-> AuditComm
    InternalAudit -- Reports to --> AuditComm
```
...
| Year | NIKE, Inc. | S&P 500 INDEX - TOTAL RETURN | DOW JONES US FOOTWEAR INDEX | S&P 500 APPAREL, ACCESSORIES & LUXURY GOODS INDEX |
| :--- | :---: | :---: | :---: | :---: |
| **2020** | $100 | $100 | $100 | $100 |
| **2021** | $140 | $140 | $140 | $195 |
| **2022** | $122 | $140 | $122 | $130 |
| **2023** | $110 | $145 | $118 | $90 |
| **2024** | $100 | $185 | $125 | $75 |
| **2025** | $65 | $210 | $82 | $92 |

*Note: Values are estimated based on the visual representation in the performance graph.*
...
| (Dollars in millions) | FOR THE TRAILING FOUR QUARTERS ENDED MAY 31, 2025 | FOR THE TRAILING FOUR QUARTERS ENDED MAY 31, 2024 |
| :--- | :---: | :---: |
| **Numerator** | | |
...
| Income tax adjustment<sup>(1)</sup> | (645) | (976) |
| Earnings before interest and after taxes | $ 3,133 | $ 5,563 |
| | | |
| | **AVERAGE FOR THE TRAILING FIVE QUARTERS ENDED MAY 31, 2025** | **AVERAGE FOR THE TRAILING FIVE QUARTERS ENDED MAY 31, 2024** |
| **Denominator** | | |
| Total debt<sup>(2)</sup> | $ 11,814 | $ 12,110 |
...
<sup>(1)</sup> Equals Earnings before interest and taxes multiplied by the effective tax rate as of each of the respective quarter ends.  
<sup>(2)</sup> Total debt includes the following: 1) Current portion of long-term debt, 2) Notes Payable, 3) Current portion of operating lease liabilities, 4) Long-term debt and 5) Operating lease liabilities.
...
| (Dollars in millions) | FISCAL 2025 | FISCAL 2024 | % CHANGE | % CHANGE EXCLUDING CURRENCY CHANGES<sup>(1)</sup> | FISCAL 2023 | % CHANGE | % CHANGE EXCLUDING CURRENCY CHANGES<sup>(1)</sup> |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **NIKE, Inc. Revenues:** | | | | | | | |
...
| **NIKE Brand Revenues by:<sup>(4)</sup>** | | | | | | | |
...
| Others<sup>(5)</sup> | (1,234) | (594) | -108 % | -106 % | (363) | -64 % | -67 % |
| Global Brand Divisions<sup>(2)</sup> | 48 | 45 | 7 % | 10 % | 58 | -22 % | -25 % |
| **TOTAL NIKE BRAND REVENUES** | **$ 44,714** | **$ 49,322** | **-9 %** | **-9 %** | **$ 48,763** | **1 %** | **1 %** |
...
### Revenue Disaggregation Charts

```mermaid
pie title Operating Segments
    "North America" : 44
    "EMEA" : 27
    "Greater China" : 15
    "APLA" : 14
...
```mermaid
pie title Distribution Channels
    "Wholesale" : 58
    "NIKE Direct" : 42
```

```mermaid
pie title Major Product Lines
    "Footwear" : 66
    "Apparel" : 29
    "Equipment" : 5
```
...
**Gross Margin Bridge (FY24 to FY25)**

| Component | Impact (Percentage Points) |
| :--- | :---: |
| **FY 24 Gross Margin** | **44.6%** |
| NIKE Brand Average Selling Price | (1.8) |
| Other Costs | (0.9) |
| Converse | (0.2) |
| Foreign Currency Exchange Rates (incl. hedges) | (0.1) |
| NIKE Brand Product Costs | 0.8 |
| Warehousing and Logistics Costs | 0.2 |
| Restructuring Charges in the Prior Year | 0.1 |
| **FY 25 Gross Margin** | **42.7%** |
...
<sup>(1)</sup> The percent change excluding currency changes represents a non-GAAP financial measure. For additional information, see "Use of Non-GAAP Financial Measures".  
...
<sup>(3)</sup> Corporate revenues primarily consist of foreign currency hedge gains and losses related to revenues generated by entities within the NIKE Brand geographic operating segments and Converse, but managed through our central foreign exchange risk management program.
...
| **TOTAL NIKE BRAND<sup>(1)</sup>** | **$ 5,740** | **$ 8,684** | **-34%** | **$ 8,359** | **4%** |
| Converse | 240 | 474 | -49% | 676 | -30% |
| Corporate | (2,202) | (2,619) | 16% | (2,840) | 8% |
| **TOTAL NIKE, INC. EARNINGS BEFORE INTEREST AND TAXES<sup>(1)</sup>** | **$ 3,778** | **$ 6,539** | **-42%** | **$ 6,195** | **6%** |
| EBIT margin<sup>(1)</sup> | 8.2% | 12.7% | | 12.1% | |
| Interest expense (income), net | (107) | (161) | — | (6) | — |
| **TOTAL NIKE, INC. INCOME BEFORE INCOME TAXES** | **$ 3,885** | **$ 6,700** | **-42%** | **$ 6,201** | **8%** |

***

<sup>(1)</sup> Total NIKE Brand EBIT, Total NIKE, Inc. EBIT and EBIT Margin represent non-GAAP financial measures. See "Use of Non-GAAP Financial Measures" for additional information.
...
| Other<sup>(1)</sup> | 123 | 152 | -19% | -19% | 154 | -1% | -2% |
| **TOTAL REVENUES** | **$ 1,692** | **$ 2,082** | **-19%** | **-18%** | **$ 2,427** | **-14%** | **-15%** |
...
<sup>(1)</sup> Other revenues consist of territories serviced by third-party licensees who pay royalties to Converse for the use of its registered trademarks and other intellectual property rights. We do not own the Converse trademarks in Japan and accordingly do not earn revenues in Japan.
...
| (Dollars in millions) | 2026 | 2027 | 2028 | 2029 | 2030 | THEREAFTER | TOTAL | FAIR VALUE |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Interest Rate Risk** | | | | | | | | |
...
| (In millions, except per share data) | Common Stock Class A Shares | Common Stock Class A Amount | Common Stock Class B Shares | Common Stock Class B Amount | Capital in Excess of Stated Value | Accumulated Other Comprehensive Income (Loss) | Retained Earnings (Deficit) | Total |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
...
| **Note 19** | Supplier Finance Programs | 88 |
...
| **(Dollars in millions)** | **ASSETS AT FAIR VALUE** | **OTHER CURRENT ASSETS** | **OTHER LONG-TERM ASSETS** | **LIABILITIES AT FAIR VALUE** | **ACCRUED LIABILITIES** | **OTHER LONG-TERM LIABILITIES** |
| **Level 2:** | | | | | | |
| Foreign exchange forwards and options<sup>(1)</sup> | $ 343 | $ 299 | $ 44 | $ 120 | $ 115 | $ 5 |
| Interest rate swaps<sup>(1)</sup> | — | — | — | 31 | — | 31 |
...
| Scheduled Maturity (Dollars in millions) | ORIGINAL PRINCIPAL | INTEREST RATE | INTEREST PAYMENTS | BOOK VALUE OUTSTANDING AS OF MAY 31, 2025 | BOOK VALUE OUTSTANDING AS OF MAY 31, 2024 |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Corporate Term Debt:<sup>(1)(2)</sup>** | | | | | |
...
| March 27, 2040<sup>(3)</sup> | 1,000 | 3.25 % | Semi-Annually | 993 | 966 |
| May 1, 2043<sup>(3)</sup> | 500 | 3.63 % | Semi-Annually | 502 | 488 |
| November 1, 2045<sup>(3)</sup> | 1,000 | 3.88 % | Semi-Annually | 997 | 986 |
...
| :--- | :---: | :---: | :---: |
| *(Dollars in millions)* | **2025** | **2024** | **2023** |
| Stock options<sup>(1)</sup> | $ 292 | $ 336 | $ 311 |
| ESPPs | 69 | 69 | 72 |
| Restricted stock and restricted stock units<sup>(1)(2)</sup> | 348 | 399 | 372 |
...
| | **SHARES<sup>(1)</sup>** | **WEIGHTED AVERAGE OPTION PRICE** |
| :--- | :---: | :---: |
| | *(In millions)* | |
...
| | SHARES<sup>(1)</sup> | WEIGHTED AVERAGE GRANT DATE FAIR VALUE |
| :--- | :---: | :---: |
| | *(In millions)* | |
...
| | AMOUNT OF GAIN (LOSS) RECOGNIZED IN OTHER COMPREHENSIVE INCOME (LOSS) ON DERIVATIVES<sup>(1)</sup> | | | LOCATION OF GAIN (LOSS) RECLASSIFIED FROM ACCUMULATED OTHER COMPREHENSIVE INCOME (LOSS) INTO INCOME | AMOUNT OF GAIN (LOSS) RECLASSIFIED FROM ACCUMULATED OTHER COMPREHENSIVE INCOME (LOSS) INTO INCOME<sup>(1)</sup> | | |
| :--- | :---: | :---: | :---: | :--- | :---: | :---: | :---: |
...
| Interest rate swaps<sup>(2)</sup> | — | — | — | Interest expense (income), net | (8) | (8) | (8) |
...
| :--- | :---: | :---: | :---: | :--- |
| | **YEAR ENDED MAY 31,** | | | **LOCATION OF GAIN (LOSS) RECOGNIZED IN INCOME ON DERIVATIVES** |
| *(Dollars in millions)* | **2025** | **2024** | **2023** | |
| **Derivatives not designated as hedging instruments:** | | | | |
...
| Reclassifications to net income of previously deferred (gains) losses<sup>(2)</sup> | — | (322) | — | 6 | (316) |
...
| Reclassifications to net income of previously deferred (gains) losses<sup>(2)</sup> | 1 | (423) | — | (6) | (428) |
...
| Other segment items<sup>(1)</sup> | (2) | 14 | (76) | (3) | (4) | (71) | (2) | (3) | (76) |
...
| Depreciation and amortization<sup>(2)</sup> | $ 157 | 143 | 49 | 50 | 237 | 636 | 14 | 125 | $ 775 |
| Inventories | $ 3,198 | 2,042 | 951 | 905 | 148 | 7,244 | 272 | (27) | $ 7,489 |

<sup>(1)</sup> At the NIKE Brand segments and Converse, other segment items consist of unusual or non-operating transactions that occur outside the normal course of business. At Corporate, this also includes foreign currency conversion gains and losses from the remeasurement of monetary assets and liabilities denominated in non-functional currencies and the impact of certain foreign currency derivative instruments.
<sup>(2)</sup> The amounts of depreciation and amortization disclosed by segment are included within Cost of sales and Operating overhead expense, as applicable.
...
| Other segment items<sup>(1)</sup> | (9) | (1) | (63) | (3) | 33 | (43) | (6) | (179) | (228) |
...
| **Supplemental information:** | | | | | | | | | |
| Depreciation and amortization<sup>(2)</sup> | $ 152 | 146 | 56 | 51 | 236 | 641 | 17 | 138 | $ 796 |
...
| Other segment items<sup>(1)</sup> | (5) | (3) | (98) | — | (9) | (115) | (7) | (158) | (280) |
...
| **Supplemental information:** | | | | | | | | | |
| Depreciation and amortization<sup>(2)</sup> | $ 128 | 120 | 54 | 42 | 211 | 555 | 17 | 131 | $ 703 |
...
<sup>(2)</sup> The amounts of depreciation and amortization by segment are included within Cost of sales and Operating overhead expense, as applicable.
...
| (Dollars in millions) | AS OF MAY 31, 2025<sup>(1)</sup> |
| :--- | :--- |
| Fiscal 2026 | $ 565 |
| Fiscal 2027 | 575 |
| Fiscal 2028 | 487 |
...
<sup>(1)</sup> *Excludes $482 million as of May 31, 2025, of future operating lease payments for lease agreements signed but not yet commenced.*
...
| /s/ ELLIOTT HILL<br>**Elliott Hill** | *President and Chief Executive Officer* | July 17, 2025 |
| **PRINCIPAL FINANCIAL OFFICER:** | | |
| /s/ MATTHEW FRIEND<br>**Matthew Friend** | *Executive Vice President and Chief Financial Officer* | July 17, 2025 |
| **PRINCIPAL ACCOUNTING OFFICER:** | | |
| /s/ JOHANNA NIELSEN<br>**Johanna Nielsen** | *Vice President, Chief Accounting Officer* | July 17, 2025 |
| **DIRECTORS:** | | |
| /s/ MARK PARKER<br>**Mark Parker** | *Director, Chairman of the Board* | July 17, 2025 |
| /s/ CATHLEEN BENKO<br>**Cathleen Benko** | *Director* | July 17, 2025 |
| /s/ TIMOTHY COOK<br>**Timothy Cook** | *Director* | July 17, 2025 |
| /s/ THASUNDA DUCKETT<br>**Thasunda Duckett** | *Director* | July 17, 2025 |
| /s/ MÓNICA GIL<br>**Mónica Gil** | *Director* | July 17, 2025 |
| /s/ MARIA HENRY<br>**Maria Henry** | *Director* | July 17, 2025 |
| /s/ PETER HENRY<br>**Peter Henry** | *Director* | July 17, 2025 |
| /s/ TRAVIS KNIGHT<br>**Travis Knight** | *Director* | July 17, 2025 |
| /s/ MICHELLE PELUSO<br>**Michelle Peluso** | *Director* | July 17, 2025 |
| /s/ JOHN ROGERS, JR.<br>**John Rogers, Jr.** | *Director* | July 17, 2025 |
| /s/ ROBERT SWAN<br>**Robert Swan** | *Director* | July 17, 2025 |
...
| DIRECTORS | CORPORATE OFFICERS |
| :--- | :--- |
| **Cathleen Benko**<sup>(3)</sup><br>Former Vice Chairman & Managing Principal<br>Deloitte LLP<br>Redwood City, California | **Elliott Hill**<br>President & Chief Executive Officer |
| **Timothy Cook**<sup>(3)(5)</sup><br>Chief Executive Officer<br>Apple Inc.<br>Cupertino, California | **Mark Parker**<br>Executive Chairman |
| **Thasunda Duckett**<sup>(4)</sup><br>President & Chief Executive Officer<br>Teachers Insurance and Annuity Association of America<br>New York, New York | **Matthew Friend**<br>Executive Vice President & Chief Financial Officer |
| **Mónica Gil**<sup>(3)</sup><br>Chief Administrative and Marketing Officer<br>NBCUniversal Telemundo Enterprises<br>Miami, Florida | **Treasure Heinle**<br>Executive Vice President, Chief People Officer |
| **Maria Henry**<sup>(2)</sup><br>Chief Financial Officer (Retired)<br>Kimberly-Clark Corporation<br>Dallas, Texas | **Robert Leinwand**<br>Executive Vice President, Chief Legal Officer |
| **Peter Henry**<sup>(2)</sup><br>Class of 1984 Senior Fellow at Stanford University’s Hoover Institution, Senior Fellow at Stanford’s Freeman Spogli Institute for International Studies and Dean Emeritus of New York University’s Leonard N. Stern School of Business<br>Stanford University<br>Stanford, California | **Philip McCartney**<br>Executive Vice President, Chief Innovation, Design & Product Officer |
| **Elliott Hill**<sup>(1)</sup><br>President & Chief Executive Officer<br>NIKE, Inc.<br>Beaverton, Oregon | **Amy Montagne**<br>President, Nike |
| **Travis Knight**<sup>(1)</sup><br>President & Chief Executive Officer<br>LAIKA, LLC<br>Hillsboro, Oregon | **Craig Williams**<br>Executive Vice President, Chief Commercial Officer |
| **Mark Parker**<sup>(1)</sup><br>Executive Chairman<br>NIKE, Inc.<br>Beaverton, Oregon | **Mary Hunter**<br>Vice President, Corporate Secretary |
| **Michelle Peluso**<sup>(4)</sup><br>Chief Executive Officer<br>Revlon Group Holdings LLC<br>New York, New York | **Paul Trussell**<br>Vice President, Treasurer |
| **John Rogers, Jr.**<sup>(4)</sup><br>Co-Chief Executive Officer & Chief Investment Officer<br>Ariel Investments, LLC<br>Chicago, Illinois | **Kelsey Baldwin**<br>Assistant Secretary |
| **Robert Swan**<sup>(2)</sup><br>Operating Partner<br>Andreessen Horowitz<br>Menlo Park, California | **Carlos Wilson**<br>Assistant Secretary |
...
| SUBSIDIARY BRANDS | LOCATIONS |
| :--- | :--- |
| **CONVERSE**<br>160 North Washington St.<br>Boston, Massachusetts 02114 | **WORLD HEADQUARTERS**<br>One Bowerman Drive<br>Beaverton, Oregon 97005-6453 |
| **JORDAN BRAND** (Jumpman Logo)<br>One Bowerman Drive<br>Beaverton, Oregon 97005-6453 | **EUROPEAN HEADQUARTERS**<br>Colosseum 1<br>1213 NL Hilversum<br>The Netherlands |
| | **GREATER CHINA HEADQUARTERS**<br>LiNa Building<br>Tower 1, No. 99<br>Jiangwancheng Road<br>Yangpu District<br>Shanghai, China 200438 |
...
Hearing Impaired #
TDD: 800-490-1493
[www.computershare.com/investor](http://www.computershare.com/investor)
...
This page appears to be the back cover or a contact information page for a NIKE, Inc. document. It features a minimalist design with a solid orange vertical bar on the right edge.
...
The following certification mark is located at the bottom right of the page:

**FSC Certification**
* **Logo:** FSC (Forest Stewardship Council)
* **Category:** MIX
* **Statement:** Paper from responsible sources
* **Standard:** FSC®
* **Website:** [www.fsc.org](http://www.fsc.org)